(function() {
  window.S3Upload = (function() {
    ...
    S3Upload.prototype.handleFileSelect = function(file_element) {
      ...
      this.onProgress(0, 'Iniciando envio...');
    ...
    S3Upload.prototype.uploadToS3 = function(file, url, public_url, opts) {
      ...
      if (!xhr) {
        ...
        xhr.onload = function() {
          if (xhr.status === 200) {
            this_s3upload.onProgress(100, 'Envio completo.', public_url, file);
            return this_s3upload.onFinishS3Put(public_url, file);
          } else {
            return this_s3upload.onError('Erro no envio: ' + xhr.status, file);
          }
        };
        ...
        xhr.upload.onprogress = function(e) {
          ...
          if (e.lengthComputable) {
            ...
            return this_s3upload.onProgress(percentLoaded, (percentLoaded === 100 ? 'Finalizando...' : 'Enviando...'), public_url, file);
          }
        };
      }
